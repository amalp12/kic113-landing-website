      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="text-center max-w-4xl px-4 mx-auto">
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-6 leading-tight tracking-tight"
          >
            {tagline}
          </motion.h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 pt-8">
            <motion.button
              ...
              className="group px-8 py-3 rounded-full text-lg font-semibold bg-cyan-600 text-white relative overflow-hidden transition-all duration-500 hover:bg-cyan-700 dark:hover:bg-cyan-500"
            >
              Explore Services
            </motion.button>
            <motion.button
              ...
              className="group px-8 py-3 rounded-full text-lg font-semibold border-2 border-cyan-600 text-cyan-600 dark:border-cyan-500 dark:text-cyan-500 hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-white transition-colors duration-300"
            >
              Get in Touch
            </motion.button>
          </div>
